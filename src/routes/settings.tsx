...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      { title: "Settings — MessMate Hostel Mess Portal" },
      {
        name: "description",
        content:
          "Customize your MessMate experience — toggle dark mode, manage meal and payment notifications, choose your preferred language, and adjust app preferences.",
      },
      { property: "og:title", content: "Settings — MessMate" },
      {
        property: "og:description",
        content:
          "Personalize MessMate with theme, notification, language and other app preferences for your hostel mess portal.",
      },
